...
export default function Home() {
  ...
  return (
    <main className="min-h-screen w-full mt-[30px] px-[30px]">
      <div className="mt-[100px]">
        <h2 className="md:max-w-[70vw] stroke text-[2.5rem] text-blue-800 md:text-[3.5rem] transition duration-100 lg:text-[5rem] font-bold cursor-pointer">
          Know your transaction cost before you send.
        </h2>
      </div>
      <div className="mt-[80px]">
      <div className="block text-2xl font-medium text-gray-300  text-center mb-[30px]">
        Select Blockchain
      </div>
      <ToggleGroup
        type="single"
      ...
      >
        <ToggleGroupItem
          className={`w-[200px] border-blue-500 hover:text-white hover:bg-blue-500 text-gray-400 data-[state=on]:bg-blue-500 data-[state=on]:text-white`}
          value="ethereum"
        ...
        <ToggleGroupItem
          className={`w-[200px] border-pink-600 hover:text-white hover:bg-pink-600  text-gray-400 data-[state=on]:bg-pink-600 data-[state=on]:text-white`}
          value="arbitrum"
        ...
        <ToggleGroupItem
          className={`w-[200px] border-purple-700 text-gray-400 hover:bg-purple-700 hover:text-white data-[state=on]:bg-purple-700 data-[state=on]:text-white`}
          value="polygon"
      ...
      <div className="mt-[50px]">
        <h3 className="text-2xl font-semibold mb-[30px] text-gray-300 text-center">
          Choose Mode
        </h3>
